...
수정할 이미지들
    - project2\kst\ocr_0.png
    - project2\kst\ocr_1.png
    - project2\kst\ocr_2.png
    - project2\kst\ocr_3.png
...
1. "프로젝트 목적"에 들어갈 내용
2. 참고 지식 (들어갈 내용은 아님)
    알약 외양 분류, 알약 각인 OCR, 설명 기반 챗봇
2. 내용에 들어갈 키워드
    알약 식별 챗봇, 사용자, 알약 정보, 앱
3. 내용 형식
    - 앱을 만드는것이 목표(목표라는 단어는 쓰지 말것)
    - 이번 프로젝트에서는 모델 개선이 목적
    - 사용자가 쉽게 빠르게 
